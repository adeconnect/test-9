                ...
                <Form id="signupForm" onSubmit={handlesubmit}>
                    ...
                    <Row className="mb-2">
                        <Form.Group as={Col} xs={6}>
                            ...
                            <Form.Control as="select" value={prog} name="program" onChange={handleChange}>
                        ...
                        <Form.Group as={Col}>
                            ...
                            <Form.Control name="matricNumber" value={matric} onChange={handleChange}/>
                        </Form.Group>

                        <Form.Group as={Col}>
                            <Form.Label>Graduation Year</Form.Label>
                            <Form.Control as="select" name="graduationYear" value={gyears} onChange={handleChange}>
                                <option>Select Option</option>
                                {gradYears.map((year) => (
